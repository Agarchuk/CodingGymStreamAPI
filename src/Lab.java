...
public class Lab {
    ...
    public void createStudents(){
        Student student1 = new Student("Hanna", LocalDate.of(2021, 03, 23));
        Student student2 = new Student("Anton", LocalDate.of(2021, 03, 23));
        Student student3 = new Student("Rustam", LocalDate.of(2021, 06, 4));
        Student student4 = new Student("Vitalii", LocalDate.of(2021, 06, 01));
        Student student5 = new Student("Marina", LocalDate.of(2021, 07, 01));
        Student student6 = new Student("Elena", LocalDate.of(2021, 07, 5));
        Student student7 = new Student("Kseniia", LocalDate.of(2021, 02, 7));
        Student student8 = new Student("Olga", LocalDate.of(2020, 12, 23));
        Student student9 = new Student("Ilia", LocalDate.of(2020, 12, 23));
        Student student10 = new Student("Aleksandr", LocalDate.of(2021, 04, 01));
        Student student11 = new Student("Hanna", LocalDate.of(2021, 05, 05));
        Student student12 = new Student("Aleksandr", LocalDate.of(2021, 05, 23));
        Student student13 = new Student("Kseniia", LocalDate.of(2021, 03, 6));
        Student student14 = new Student("Elena", LocalDate.of(2021, 04, 23));
        Student student15 = new Student("Ilia", LocalDate.of(2021, 07, 23));
